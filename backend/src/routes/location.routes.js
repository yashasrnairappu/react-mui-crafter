...
import { addLocation, city, district, deleteLocation, getLocations, getSingleLocation, updateLocation ,proxyImage} from '../controllers/location.controller.js';
import upload from '../middleware/upload.js';

router.post("/addlocations",protectAdmin,upload.array("images", 10),addLocation)
router.get("/locations", getLocations);
router.get('/location/cities', city)
router.get('/location/districts', district)
